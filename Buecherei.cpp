...
int main()
{
    ...
    do  // Anzeige des Men�s
    {
        std::cout << std::endl
				  ...
				  << "(6): Alle ausgeliehenen Medien anzeigen\n " << std::endl
                  << "(7): Beenden" << std::endl;
...
void fuelleDatenbank(std::vector<Medium*>& medien)
{
#if UNTERKLASSENVORHANDEN
    {
        ...
        neuesMedium = new Magazin("Chip", Datum(1, 12, 2025), "Computer");
        medien.push_back(neuesMedium);
...
//////////////////////////////////////////////////////////////////
// Gibt alle Medien aus, die aktuell ausgeliehen sind. //
//////////////////////////////////////////////////////////////////
void ausgelieheneMedienAusgeben(const std::vector<Medium*>& medien)
{
	bool hatEtwas = false;
	...
	if (!hatEtwas)
	{
		std::cout << "Kein Medium ist derzeit ausgeliehen." << std::endl;
	}
